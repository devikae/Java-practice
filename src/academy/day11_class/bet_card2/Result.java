...
public class Result {
	...
	public static void play1Win(String play1name, String play2name) {
		System.out.println("========================================");
		System.out.println(play2name + " 님이 가진 돈을 모두 잃으셨습니다.");
		System.out.println("========================================");

	}
	
	public static void play1Win1(String play1name, String play2name) {
		System.out.println("========================================");
	...
	public static void play2Win(String play1name, String play2name) {
		System.out.println("========================================");
		System.out.println(play1name + " 님이 가진 돈을 모두 잃으셨습니다.");
		System.out.println("========================================");
	}
	
	public static void play2Win2(String play1name, String play2name) {
		System.out.println("========================================");
		System.out.println("           V I C T O R Y           ");
		System.out.println("========================================");
